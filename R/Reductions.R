...
#' @param pc Number of principal components to use (estimated from the Elbow
...
#' information.
#' @param k.neighbors (\code{Seurat}'s \code{k.param}). Defines \emph{k} for the
...
#' \code{DSS}) signature (\code{add.DSS = TRUE}) or just use the
