...
#' normalized BCS in \code{@@data} is 0 (one switch point per signature).
...
#' DSS signatures. Useful to compute the UMAP reduction and the therapeutic
#' clusters when the number of drug signatures is low.
